...
(function ($) {
    ...
    DayScheduleSelector.prototype.renderHeader = function () {
        ...
        $.each(days, function (i, _) {
            html += '<th class="schedule-header-cell">' + (stringDays[days[i]] || '') + '</th>';
        });
        this.$el.find('.schedule-header').html('<tr><th class="schedule-header-label"></th>' + html + '</tr>');
    };
    ...
    DayScheduleSelector.prototype.renderRows = function () {
        ...
        $.each(generateDates(start, end, interval), function (i, d) {
            ...
            $el.append('<tr><td class="time-label">' + _this.hhmmText(d) + '</td>' + daysInARow + '</tr>');
        });
    };
     ...
     */
    DayScheduleSelector.prototype.hhmmText = function (date) {
